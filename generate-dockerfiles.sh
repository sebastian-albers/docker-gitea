...
for docker_arch in amd64 arm32v7 arm64v8; do
  case ${docker_arch} in
    amd64   ) qemu_arch="x86_64"  ; gitea_arch="linux-amd64" ; go_arch="amd64" ;;
    arm32v7 ) qemu_arch="arm"     ; gitea_arch="linux-arm-6" ; go_arch="arm"   ;;
    arm64v8 ) qemu_arch="aarch64" ; gitea_arch="linux-arm64" ; go_arch="arm64" ;;
  esac
